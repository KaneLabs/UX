...
var _Animated = _interopRequireDefault(
  require('react-native-web/dist/exports/Animated'),
);
...
var _this = this,
  _jsxFileName =
    '/Users/kane/Lab/Eros/src/components/Utils/Hoverable/Hoverable.stories.js';
var store = new _storybookState.Store({
  color: '#00BCD4',
  left: new _Animated.default.Value(0),
});
var _default = (0, _storiesOf.storiesOf)('Utils|Hoverable', module)
  ...
  .add('Simple', function() {
    return _react.default.createElement(
      ...
      _react.default.createElement(_Header.default, {
        title: 'Hoverable',
        subtitle: 'Cross Platform Hover Component',
        __self: _this,
            ...
            _react.default.createElement(
              _.Hoverable,
              {
                onHoverIn: function onHoverIn() {
                  return store.set({ color: '#009688' });
                },
                onHoverOut: function onHoverOut() {
                  return store.set({ color: '#00BCD4' });
                },
                __self: _this,
                __source: {
                  fileName: _jsxFileName,
          ...
          return _react.default.createElement(
            ...
            _react.default.createElement(
              _.Hoverable,
              {
                onHoverIn: function onHoverIn() {
                  _Animated.default
                    .timing(state.left, { toValue: 1, duration: 500 })
                    .start();
                },
                onHoverOut: function onHoverOut() {
                  _Animated.default
                    .timing(state.left, { toValue: 0, duration: 500 })
                    .start();
                },
                __self: _this,
                __source: {
