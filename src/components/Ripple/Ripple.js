...
export default class Ripple extends PureComponent {
  ...
  webGetPositionInElement = (e) => {
    ...
    const x = e.nativeEvent.pageX - rect.left; // x position within the element.
    const y = e.nativeEvent.changedTouches[0].clientY - rect.top; // y position within the element.
    return { x, y };
  };
