...
export const InlineSpacer = () => <BodyText text="·" style={styles.inlineSpacer} />;

export const PostHeaderHeadline = ({
  display, handle, createdAt, location = null,
}) => (
  <View style={styles.postHeaderContent}>
    <Row center style={styles.postHeaderTopline}>
      ...
      <BodyText text={`${formatCreatedAt(createdAt)}`} style={styles.postTime} />
    </Row>
...
export const PostHeader = ({
  avatarUrl, display, handle, createdAt,
}) => (
  <Row styles={styles.postHeader}>
    <PostAvatarButton avatarUrl={avatarUrl} />
    <PostHeaderHeadline display={display} handle={handle} createdAt={createdAt} />
  </Row>
);
